		...
		public static function checkout_scripts() 
		{
			if ( is_checkout() ) {
				if ( ! get_query_var( 'order-received' ) ) {
					...
					$fields_is_required['billing_persontype']    = $fields['billing']['billing_persontype']['required'];
					$fields_is_required['billing_neighborhood']  = $fields['billing']['billing_neighborhood']['required'];
					$fields_is_required['billing_number']        = $fields['billing']['billing_number']['required'];
					$fields_is_required['billing_birthdate']     = $fields['billing']['billing_birthdate']['required'];
					$fields_is_required['billing_cpf']           = $fields['billing']['billing_cpf']['required'];
					$fields_is_required['billing_cnpj']          = $fields['billing']['billing_cnpj']['required'];
					$fields_is_required['shipping_neighborhood'] = $fields['shipping']['shipping_neighborhood']['required'];
					$fields_is_required['shipping_number']       = $fields['shipping']['shipping_number']['required'];
