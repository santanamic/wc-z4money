...
if ( ! class_exists( 'Wc_Z4Money_Environment' ) ) {
 ...
 */
	 ...
	 */
		...
		$this->_woocommerce_version      = Wc_Z4Money_Helper::woocommerce_version();
	 ...
	 */
		...
		$all_active_plugins         = Wc_Z4Money_Helper::wordpress_plugins();
