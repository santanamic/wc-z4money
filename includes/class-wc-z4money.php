 ...
 */
	 ...
	 */
		...
		{
			_doing_it_wrong( __FUNCTION__, __( 'Cheatin&#8217; huh?', 'wc-z4money' ), '1.0.0' );
		}
	 ...
	 */
		...
		{
			return Wc_Z4Money_Environment::instance();
		}
	 ...
	 */
		...
		{
			$payment_methods[] = 'Wc_Z4Money_Gateway_Method_CreditCard';
			$payment_methods[] = 'Wc_Z4Money_Gateway_Method_Boleto';
	...
	public static function hides_when_is_outside_brazil( $available_gateways ) 
	{
		if ( isset( $_REQUEST['country'] ) && 'BR' !== $_REQUEST['country'] ) { // WPCS: input var ok, CSRF ok.
			unset( $available_gateways['Wc_Z4Money_Gateway_Method_CreditCard'] );
			unset( $available_gateways['Wc_Z4Money_Gateway_Method_Boleto'] );
		}
